        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] border border-white/20 p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center">
                  <input type="checkbox" className="rounded border-white/20 bg-white/10 text-purple-600 focus:ring-purple-500" />
                  <span className="ml-2 text-white/80">Remember me</span>
                </label>
                <Link href="/forgot-password" className="text-white/80 hover:text-white font-medium transition-colors">
                  Forgot Password?
                </Link>
              </div>
            ...
            <p className="mt-8 text-center text-sm text-white/80">
              ...
              <Link href="/register" className="font-medium text-white hover:text-white/90 transition-colors">
                Create Account
              </Link>
            </p>
